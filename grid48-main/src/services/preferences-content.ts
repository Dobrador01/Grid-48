...
const DESKTOP_RELEASES_URL = 'https://github.com/koala73/grid48/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/koala73/grid48/discussions/94" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
