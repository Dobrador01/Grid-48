...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/grid48/conflict/v1/handler.ts', 'server/grid48/infrastructure/v1/handler.ts', 'server/grid48/cyber/v1/handler.ts', 'server/grid48/maritime/v1/handler.ts', 'server/grid48/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/grid48/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/grid48/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/grid48/military/v1/handler.ts'],
    locality: 'api-key',
