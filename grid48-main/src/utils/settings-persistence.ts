...
const SETTINGS_KEY_PREFIXES = [
  ...
  'grid48-monitors',
  'grid48-layers',
  'grid48-disabled-feeds',
  'grid48-live-channels',
  'grid48-map-mode',
  'grid48-variant',
  'grid48-theme',
  'grid48-panel-spans',
  'grid48-panel-order',
  'grid48-runtime-feature-toggles',
  'grid48-breaking-alerts-v1',
  'grid48-globe-render-scale',
  'grid48-live-streams-always-on',
  'grid48-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('grid48-variant') || 'full',
    data,
  };
  ...
  a.download = `grid48-settings-${ts}.json`;
