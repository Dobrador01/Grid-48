...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  marketsFinance: {
    ...
    panelKeys: ['gulf-economies', 'etf-flows', 'stablecoins'],
    variants: ['full'],
  },
  topical: {
  ...
  dataTracking: {
    ...
    panelKeys: ['ucdp-events', 'displacement', 'climate', 'population-exposure', 'security-advisories', 'oref-sirens', 'world-clock', 'tech-readiness'],
    variants: ['full'],
  },
  ...
  techAi: {
    ...
    panelKeys: ['hardware', 'cloud', 'dev', 'github', 'producthunt', 'events', 'service-status', 'tech-readiness'],
    variants: ['tech'],
  },
  startupsVc: {
  ...
  techMarkets: {
    ...
    panelKeys: ['etf-flows', 'stablecoins', 'world-clock'],
    variants: ['tech'],
  },
  ...
  finMarkets: {
    labelKey: 'header.panelCatMarkets',
    panelKeys: ['stock-analysis', 'stock-backtest', 'daily-market-brief', 'markets-news', 'analysis'],
    variants: ['finance'],
  },
  fixedIncomeFx: {
  ...
  finCommodities: {
    ...
    panelKeys: ['commodities-news'],
    variants: ['finance'],
  },
  cryptoDigital: {
    labelKey: 'header.panelCatCryptoDigital',
    panelKeys: ['crypto-news', 'etf-flows', 'stablecoins', 'fintech'],
    variants: ['finance'],
  },
  centralBanksEcon: {
    labelKey: 'header.panelCatCentralBanks',
    panelKeys: ['centralbanks', 'economic-news'],
    variants: ['finance'],
  },
  dealsInstitutional: {
