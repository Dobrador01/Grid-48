  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://grid48.app')}"
            ...
            <a href="${vHref('tech', 'https://tech.grid48.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.grid48.app')}"
            ...
            <a href="${vHref('commodity', 'https://commodity.grid48.app')}"
            ...
            <a href="${vHref('happy', 'https://happy.grid48.app')}"
               class="variant-option active"
               data-variant="happy"
               ${vTarget('happy')}
          ...
          <span class="logo">GRID 48</span><span class="logo-mobile">GRID 48</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/koala73/grid48" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">GRID 48</span>
