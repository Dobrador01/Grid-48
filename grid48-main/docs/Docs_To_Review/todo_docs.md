...
- [ ] Nginx configuration (reference `deploy/nginx-grid48.conf`)
- [ ] SystemD service setup (reference `deploy/grid48-api.service`)
...
- [ ] Add entries for UI customizations on `feat/ui-customizations-grid48` branch
