...
If you discover a security vulnerability in Grid 48, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/koala73/grid48/security/advisories/new) to submit your report directly through the repository.
...
Grid 48 is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Grid 48 aggregates publicly available OSINT data
...
- Vulnerabilities in the Grid 48 codebase
...
Thank you for helping keep Grid 48 and its users safe! 🔒
