...
All notable changes to Grid 48 are documented here.
...
- **Edge caching**: Cloudflare edge caching for proxy.grid48.app (#478) and api.grid48.app (#471)
...
- **Finance variant**: Added a dedicated market-first variant (`finance.grid48.app`) with finance/trading-focused feeds, panels, and map defaults
...
- **CORS hardening**: Tighten Vercel preview deployment regex to block origin spoofing (`grid48EVIL.vercel.app`)
