...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  techNews: { labelKey: 'header.sourceRegionTechNews', feedKeys: ['hardware'] },
  aiMl: { labelKey: 'header.sourceRegionAiMl', feedKeys: [] },
  ...
  techMedia: { labelKey: 'header.sourceRegionTechMedia', feedKeys: ['podcasts'] },

  // Finance variant regions
  marketsAnalysis: { labelKey: 'header.sourceRegionMarkets', feedKeys: ['analysis', 'ipo'] },
  fixedIncomeFx: { labelKey: 'header.sourceRegionFixedIncomeFx', feedKeys: ['forex', 'bonds'] },
  commoditiesRegion: { labelKey: 'header.sourceRegionCommodities', feedKeys: [] },
  cryptoDigital: { labelKey: 'header.sourceRegionCryptoDigital', feedKeys: ['fintech'] },
  centralBanksEcon: { labelKey: 'header.sourceRegionCentralBanks', feedKeys: ['centralbanks'] },
